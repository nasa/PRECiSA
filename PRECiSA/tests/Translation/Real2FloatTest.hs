...
real2fpActArgs__test1 = testCase "real2fpActArgs__test1" $
  real2fpActArgs False False FPDouble [] [Arg "x" Real] [BinaryOp AddOp (Int 2) (Rat (fromDouble2Rat 0.2))]
  @?=
...
real2fpActArgs__test2 = testCase "real2fpActArgs__test2" $
  real2fpActArgs False False FPDouble [] [Arg "x" TInt] [BinaryOp AddOp (Int 2) (Int 3)]
  @?=
  [BinaryFPOp AddOp TInt (FInt 2) (FInt 3)]

real2fpActArgs__test3 = testCase "real2fpActArgs__test3" $
  real2fpActArgs False False FPDouble [] [Arg "x" Real] [BinaryOp AddOp (Int 2) (Int 3)]
  @?=
...
testReal2fpAexpr__test1 = testCase "real2fpAexpr(Int + Rat) = cast(Int) + Rat" $
  real2fpAexpr False False FPDouble [] (BinaryOp AddOp (Int 2) (Rat (fromDouble2Rat 0.2)))
  @?=
  BinaryFPOp AddOp FPDouble (TypeCast TInt FPDouble (FInt 2)) (ToFloat FPDouble (Rat $ fromDouble2Rat 0.2))

testReal2fpAexpr__test2 = testCase "real2fpAexpr(IntSum + Rat) = cast(IntSum) + Rat" $
  real2fpAexpr False False FPDouble [] (BinaryOp AddOp (BinaryOp AddOp (Int 2) (Int 4)) (Rat (fromDouble2Rat 0.2)))
  @?=
...
testReal2fpAexpr__test3 = testCase "real2fpAexpr(Rat + Int) = Rat + cast(Int)" $
  real2fpAexpr False False FPDouble [] (BinaryOp AddOp (Rat (fromDouble2Rat 0.2)) (Int 2))
  @?=
...
testReal2fpAexpr__test4 = testCase "real2fpAexpr(Rat + Rat) = Rat + Rat" $
  real2fpAexpr False False FPDouble [] (BinaryOp AddOp (Rat (fromDouble2Rat 0.2)) (Rat (fromDouble2Rat 0.4)))
  @?=
...
testReal2fpAexpr__test5 = testCase "real2fpAexpr(Int + Int) = Int + Int" $
  real2fpAexpr False False TInt [] (BinaryOp AddOp (Int 2) (Int 5))
  @?=
...
testReal2fpAexpr__test6 = testCase "real2fpAexpr(If x>0 then x else 5) = If x>0 then x else (double) 5" $
  real2fpAexpr False False FPDouble [] (RIte (Rel Gt (Var Real "x") (Int 0)) (Var Real "x") (Int 5))
  @?=
...
testReal2fpAexpr__test7 = testCase "real2fpAexpr(If p(x) then 4 else 5) = If x>0 then x else (double) 5" $
  real2fpAexpr False False FPDouble [RPred "p" [Arg "y" Real] (RBExpr BTrue)] (RIte (EPred "p" [Var Real "x"]) (Int 4) (Int 5))
  @?=
...
testReal2fpBexpr__test1 = testCase "real2fpBexpr(Int < Rat) = cast(Int) < Rat" $
  real2fpBexpr False False FPDouble [] (Rel Lt (Int 2) (Rat (fromDouble2Rat 0.2)))
  @?=
...
testReal2fpBexpr__test2 = testCase "real2fpBexpr(Int < Rat) = cast(Int) < Rat" $
  real2fpBexpr False False FPDouble [] (Rel LtE (Int 2) (Rat (fromDouble2Rat 0.2)))
  @?=
...
testReal2fpBexpr__test3 = testCase "real2fpBexpr(Rat > IntSum) = Rat > cast(IntSum)" $
  real2fpBexpr False False FPDouble [] (Rel Gt (Rat (fromDouble2Rat 0.2)) (BinaryOp AddOp (Int 2) (Int 4)))
  @?=
...
testReal2fpBexpr__test4 = testCase "real2fpBexpr(Rat >= IntSum) = Rat > cast(Int)" $
  real2fpBexpr False False FPDouble [] (Rel GtE (Rat (fromDouble2Rat 0.2)) (BinaryOp AddOp (Int 2) (Int 4)))
  @?=
...
real2fpDecl__test1 = testCase "real2fpDecl 1" $
  real2fpDecl False FPDouble [RDecl TInt "f" [Arg "x" Real] (RIte (EPred "p" [Var Real "x"]) (Int 4) (Int 5))
