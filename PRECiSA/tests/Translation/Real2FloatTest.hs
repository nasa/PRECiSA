...
real2fpActArgs__test1 = testCase "real2fpActArgs__test1" $
  real2fpActArgs False FPDouble [] [Arg "x" Real] [BinaryOp AddOp (Int 2) (Rat (toRational 0.2))]
  @?=
  [BinaryFPOp AddOp FPDouble (TypeCast TInt FPDouble $ FInt 2) (ToFloat FPDouble $ Rat (toRational 0.2))]
...
testReal2fpAexpr__test1 = testCase "real2fpAexpr(Int + Rat) = cast(Int) + Rat" $
  real2fpAexpr False FPDouble [] (BinaryOp AddOp (Int 2) (Rat (toRational 0.2)))
  @?=
  BinaryFPOp AddOp FPDouble (TypeCast TInt FPDouble (FInt 2)) (ToFloat FPDouble (Rat $ toRational 0.2))

testReal2fpAexpr__test2 = testCase "real2fpAexpr(IntSum + Rat) = cast(IntSum) + Rat" $
  real2fpAexpr False FPDouble [] (BinaryOp AddOp (BinaryOp AddOp (Int 2) (Int 4)) (Rat (toRational 0.2)))
  @?=
  BinaryFPOp AddOp FPDouble (TypeCast TInt FPDouble (BinaryFPOp AddOp TInt (FInt 2) (FInt 4))) (ToFloat FPDouble (Rat $ toRational 0.2))

testReal2fpAexpr__test3 = testCase "real2fpAexpr(Rat + Int) = Rat + cast(Int)" $
  real2fpAexpr False FPDouble [] (BinaryOp AddOp (Rat (toRational 0.2)) (Int 2))
  @?=
  BinaryFPOp AddOp FPDouble (ToFloat FPDouble (Rat $ toRational 0.2)) (TypeCast TInt FPDouble (FInt 2))

testReal2fpAexpr__test4 = testCase "real2fpAexpr(Rat + Rat) = Rat + Rat" $
  real2fpAexpr False FPDouble [] (BinaryOp AddOp (Rat (toRational 0.2)) (Rat (toRational 0.4)))
  @?=
  BinaryFPOp AddOp FPDouble (ToFloat FPDouble (Rat $ toRational 0.2)) (ToFloat FPDouble (Rat $ toRational 0.4))
...
testReal2fpBexpr__test1 = testCase "real2fpBexpr(Int < Rat) = cast(Int) < Rat" $
  real2fpBexpr False FPDouble [] (Rel Lt (Int 2) (Rat (toRational 0.2)))
  @?=
  FRel Lt (TypeCast TInt FPDouble (FInt 2)) (ToFloat FPDouble (Rat $ toRational 0.2))

testReal2fpBexpr__test2 = testCase "real2fpBexpr(Int < Rat) = cast(Int) < Rat" $
  real2fpBexpr False FPDouble [] (Rel LtE (Int 2) (Rat (toRational 0.2)))
  @?=
  FRel LtE (TypeCast TInt FPDouble (FInt 2)) (ToFloat FPDouble (Rat $ toRational 0.2))

testReal2fpBexpr__test3 = testCase "real2fpBexpr(Rat > IntSum) = Rat > cast(IntSum)" $
  real2fpBexpr False FPDouble [] (Rel Gt (Rat (toRational 0.2)) (BinaryOp AddOp (Int 2) (Int 4)))
  @?=
  FRel Gt (ToFloat FPDouble (Rat $ toRational 0.2)) (TypeCast TInt FPDouble $ BinaryFPOp AddOp TInt (FInt 2) (FInt 4))

testReal2fpBexpr__test4 = testCase "real2fpBexpr(Rat >= IntSum) = Rat > cast(Int)" $
  real2fpBexpr False FPDouble [] (Rel GtE (Rat (toRational 0.2)) (BinaryOp AddOp (Int 2) (Int 4)))
  @?=
  FRel GtE (ToFloat FPDouble (Rat $ toRational 0.2)) (TypeCast TInt FPDouble $ BinaryFPOp AddOp TInt (FInt 2) (FInt 4))
