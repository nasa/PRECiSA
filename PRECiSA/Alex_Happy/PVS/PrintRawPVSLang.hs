...
instance Print AbsRawPVSLang.Decl where
  prt i = \case
    AbsRawPVSLang.DeclTypeAlias id_ type_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString ":"), doc (showString "TYPE"), doc (showString "="), prt 0 type_])
    AbsRawPVSLang.DeclFunction id_ args type_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString ":"), prt 0 type_, doc (showString "="), prt 0 expr])
    AbsRawPVSLang.DeclConstant id_ type_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString ":"), prt 0 type_, doc (showString "="), prt 0 expr])
